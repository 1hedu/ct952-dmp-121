/* 8x8 font extracted verbatim from banner.c -- the glyph set already proven
 * legible on the real DP700WD panel. Shared so the card-dump AP can render
 * its status without re-deriving the font. */
#ifndef CT952_FONT8X8_H
#define CT952_FONT8X8_H
#include <stdint.h>
